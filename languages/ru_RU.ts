...
<context>
    ...
    <message id="ytplayer-msg-download-failed">
        <location filename="../qml/YTPlayer.qml" line="138"/>
    ...
    <message id="ytplayer-label-network-offline">
        <location filename="../qml/cover/NetworkOffline.qml" line="65"/>
        <location filename="../qml/pages/NetworkOffline.qml" line="83"/>
...
3-clause BSD</translation>
    ...
    <message id="ytplayer-action-view-license">
        ...
        <location filename="../qml/pages/ThirdPartySoftware.qml" line="74"/>
    ...
    <message id="ytplayer-title-subscription-videos">
        <location filename="../qml/pages/Account.qml" line="56"/>
    ...
    <message id="ytplayer-msg-launching-browser">
        <location filename="../qml/pages/BrowserLauncher.qml" line="67"/>
        <source>Launching browser</source>
        <extracomment>Message informing the user web browser is being launched</extracomment>
        <translation>Браузер запускается</translation>
    </message>
    <message id="ytplayer-label-clear-cache">
        <location filename="../qml/pages/CacheSettings.qml" line="51"/>
    ...
    <message id="ytplayer-msg-clearing-cache">
        <location filename="../qml/pages/CacheSettings.qml" line="55"/>
    ...
    <message id="ytplayer-title-cache-settings">
        <location filename="../qml/pages/CacheSettings.qml" line="74"/>
        <source>Cache settings</source>
        <extracomment>Title of cache settings page</extracomment>
        <translation>Настройки кеширования</translation>
    </message>
    <message id="ytplayer-label-image-cache-size">
        <location filename="../qml/pages/CacheSettings.qml" line="80"/>
    ...
    <message id="ytplayer-label-current-usage">
        <location filename="../qml/pages/CacheSettings.qml" line="96"/>
        <location filename="../qml/pages/CacheSettings.qml" line="121"/>
    ...
    <message id="ytplayer-label-api-req-cache-size">
        <location filename="../qml/pages/CacheSettings.qml" line="105"/>
    ...
    <message id="ytplayer-msg-channel-subscribed">
        <location filename="../qml/pages/ChannelBrowser.qml" line="129"/>
    ...
    <message id="ytplayer-msg-channel-unsubscribed">
        <location filename="../qml/pages/ChannelBrowser.qml" line="138"/>
    ...
    <message id="ytplayer-channel-unsubscribe">
        <location filename="../qml/pages/ChannelBrowser.qml" line="205"/>
    ...
    <message id="ytplayer-channel-subscribe">
        <location filename="../qml/pages/ChannelBrowser.qml" line="208"/>
        <source>Subscribe</source>
        <translation>Подписаться</translation>
    </message>
    <message id="ytplayer-msg-unsubscribing-channel">
        <location filename="../qml/pages/ChannelBrowser.qml" line="214"/>
    ...
    <message id="ytplayer-label-channel-unavailable">
        <location filename="../qml/pages/ChannelBrowser.qml" line="228"/>
    ...
    <message id="ytplayer-label-video-count">
        <location filename="../qml/pages/ChannelBrowser.qml" line="333"/>
    ...
    <message id="ytplayer-label-latest-videos">
        <location filename="../qml/pages/ChannelBrowser.qml" line="345"/>
        <source>Latest videos</source>
    ...
    <message id="ytplayer-title-download-settings">
        <location filename="../qml/pages/DownloadSettings.qml" line="38"/>
        <source>Download settings</source>
        <extracomment>Title of video download settings pge</extracomment>
        <translation>Настройки загрузок</translation>
    </message>
    <message id="ytplayer-label-autoresume">
        <location filename="../qml/pages/DownloadSettings.qml" line="44"/>
    ...
    <message id="ytplayer-description-autoresume">
        <location filename="../qml/pages/DownloadSettings.qml" line="48"/>
    ...
    <message id="ytplayer-label-max-concurrent-downloads">
        <location filename="../qml/pages/DownloadSettings.qml" line="60"/>
    ...
    <message id="ytplayer-label-preferred-quality">
        <location filename="../qml/pages/DownloadSettings.qml" line="78"/>
    ...
    <message id="ytplayer-action-wifi-cellular">
        ...
        <translation>WiFi + мобильный интернет</translation>
    </message>
    <message id="ytplayer-action-cellular-only">
        ...
        <translation>Только мобильный интернет</translation>
    </message>
    <message id="ytplayer-title-downloaded-videos">
        <location filename="../qml/pages/DownloadedVideos.qml" line="52"/>
    ...
    <message id="ytplayer-label-no-videos">
        ...
        <location filename="../qml/pages/WatchedRecently.qml" line="94"/>
...
Label informing the user there are no watched recently videos</extracomment>
    ...
    <message id="ytplayer-msg-cancelling-download">
        ...
        <location filename="../qml/pages/VideoOverview.qml" line="240"/>
    ...
    <message id="ytplayer-msg-saving-log">
        <location filename="../qml/pages/LogViewer.qml" line="60"/>
    ...
    <message id="ytplayer-msg-log-saved">
        <location filename="../qml/pages/LogViewer.qml" line="86"/>
    ...
    <message id="ytplayer-action-hide-search">
        ...
        <location filename="../qml/pages/WatchedRecently.qml" line="65"/>
    ...
    <message id="ytplayer-action-search">
        ...
        <location filename="../qml/pages/WatchedRecently.qml" line="68"/>
    ...
    <message id="ytplayer-label-network-connection-retry">
        <location filename="../qml/pages/NetworkOffline.qml" line="96"/>
        <source>Retry</source>
    ...
    <message id="ytplayer-label-search">
        <location filename="../qml/pages/Search.qml" line="193"/>
        <source>Search</source>
    ...
    <message id="ytplayer-search-no-results">
        ...
        <translation>Видео не найдены</translation>
    </message>
    <message id="ytplayer-title-search-options">
        <location filename="../qml/pages/SearchOptions.qml" line="98"/>
        <source>Search options</source>
        <extracomment>Search options page title</extracomment>
        <translation>Параметры поиска</translation>
    </message>
    <message id="ytplayer-label-result-type">
        <location filename="../qml/pages/SearchOptions.qml" line="104"/>
    ...
    <message id="ytplayer-label-any">
        <location filename="../qml/pages/SearchOptions.qml" line="109"/>
        <location filename="../qml/pages/SearchOptions.qml" line="147"/>
        <location filename="../qml/pages/SearchOptions.qml" line="179"/>
        <location filename="../qml/pages/SearchOptions.qml" line="217"/>
        <location filename="../qml/pages/SearchOptions.qml" line="249"/>
        <location filename="../qml/pages/SearchOptions.qml" line="281"/>
        <source>Any</source>
    ...
    <message id="ytplayer-label-channel">
        ...
        <location filename="../qml/pages/VideoOverview.qml" line="467"/>
...
Label for channel name text field</extracomment>
    ...
    <message id="ytplayer-label-video">
        <location filename="../qml/pages/SearchOptions.qml" line="127"/>
        <source>Video</source>
    ...
    <message id="ytplayer-label-video-quality">
        ...
        <location filename="../qml/pages/VideoPlayer.qml" line="539"/>
...
Label for menu option allowing the user to change video quality</extracomment>
    ...
    <message id="ytplayer-label-high-definition">
        <location filename="../qml/pages/SearchOptions.qml" line="152"/>
    ...
    <message id="ytplayer-label-standard-definition">
        <location filename="../qml/pages/SearchOptions.qml" line="158"/>
    ...
    <message id="ytplayer-label-video-duration">
        <location filename="../qml/pages/SearchOptions.qml" line="175"/>
    ...
    <message id="ytplayer-label-video-episode">
        <location filename="../qml/pages/SearchOptions.qml" line="222"/>
        <source>Episode</source>
        <extracomment>Label for episode video type</extracomment>
        <translation>Видео</translation>
    </message>
    <message id="ytplayer-label-video-movie">
        <location filename="../qml/pages/SearchOptions.qml" line="228"/>
        <source>Movie</source>
    ...
    <message id="ytplayer-label-video-license">
        <location filename="../qml/pages/SearchOptions.qml" line="245"/>
    ...
    <message id="ytplayer-label-cretive-commons-license">
        <location filename="../qml/pages/SearchOptions.qml" line="254"/>
    ...
    <message id="ytplayer-label-youtube-license">
        <location filename="../qml/pages/SearchOptions.qml" line="260"/>
        <source>YouTube</source>
        <extracomment>Label for YouTube license type</extracomment>
        <translation>YouTube</translation>
    </message>
    <message id="ytplayer-label-video-event-type">
        <location filename="../qml/pages/SearchOptions.qml" line="277"/>
    ...
    <message id="ytplayer-label-completed-event">
        <location filename="../qml/pages/SearchOptions.qml" line="286"/>
        <source>Completed</source>
        <extracomment>Label for completed event type option</extracomment>
        <translation>Произошедшие</translation>
    </message>
    <message id="ytplayer-label-live-event">
        <location filename="../qml/pages/SearchOptions.qml" line="292"/>
        <source>Live</source>
    ...
    <message id="ytplayer-label-upcoming-event">
        <location filename="../qml/pages/SearchOptions.qml" line="298"/>
        <source>Upcoming</source>
        <extracomment>Label for upcoming event type option</extracomment>
        <translation>Планируемые</translation>
    </message>
    <message id="ytplayer-label-results-order-by">
        <location filename="../qml/pages/SearchOptions.qml" line="315"/>
    ...
    <message id="ytplayer-label-order-relevance">
        <location filename="../qml/pages/SearchOptions.qml" line="320"/>
        <source>Relevance</source>
        <extracomment>Label for relevance ordering menu option</extracomment>
        <translation>По релевантности</translation>
    </message>
    <message id="ytplayer-label-order-date">
        <location filename="../qml/pages/SearchOptions.qml" line="325"/>
        <source>Date</source>
        <extracomment>Label for date ordering menu option</extracomment>
        <translation>По дате загрузки</translation>
    </message>
    <message id="ytplayer-label-order-rating">
        <location filename="../qml/pages/SearchOptions.qml" line="331"/>
        <source>Rating</source>
        <extracomment>Label for rating ordering menu option</extracomment>
        <translation>По рейтингу</translation>
    </message>
    <message id="ytplayer-label-order-title">
        <location filename="../qml/pages/SearchOptions.qml" line="337"/>
        <source>Title</source>
    ...
    <message id="ytplayer-label-safe-search-moderate">
        <location filename="../qml/pages/SearchOptions.qml" line="371"/>
        <source>Moderate</source>
        <extracomment>Label for moderate content search filtering option</extracomment>
        <translation>Умеренная</translation>
    </message>
    <message id="ytplayer-label-safe-search-none">
        <location filename="../qml/pages/SearchOptions.qml" line="376"/>
        <source>None</source>
    ...
    <message id="ytplayer-msg-clearing-history">
        <location filename="../qml/pages/SearchSettings.qml" line="65"/>
    ...
    <message id="ytplayer-title-search-settings">
        <location filename="../qml/pages/SearchSettings.qml" line="79"/>
    ...
    <message id="ytplayer-label-suggestion-engine">
        <location filename="../qml/pages/SearchSettings.qml" line="86"/>
    ...
    <message id="ytplayer-label-google-suggestion-engine">
        <location filename="../qml/pages/SearchSettings.qml" line="100"/>
    ...
    <message id="ytplayer-label-history-suggestion-engine">
        <location filename="../qml/pages/SearchSettings.qml" line="108"/>
    ...
    <message id="ytplayer-title-third-party-software">
        <location filename="../qml/pages/ThirdPartySoftware.qml" line="22"/>
        <source>Third party software</source>
    ...
    <message id="ytplayer-status-buffering">
        <location filename="../qml/pages/VideoPlayer.qml" line="276"/>
    ...
    <message id="ytplayer-status-invalid-media">
        <location filename="../qml/pages/VideoPlayer.qml" line="310"/>
    ...
    <message id="ytplayer-msg-direct-playback-impossible">
        <location filename="../qml/pages/VideoPlayer.qml" line="104"/>
        ...
        <translation type="unfinished">Прямое воспроизведение видео не доступно</translation>
    </message>
    <message id="ytplayer-status-looking-for-streams">
        <location filename="../qml/pages/VideoPlayer.qml" line="36"/>
    ...
    <message id="ytplayer-msg-direct-playback-impossible-desc">
        <location filename="../qml/pages/VideoPlayer.qml" line="107"/>
    ...
    <message id="ytplayer-msg-video-unavailable">
        <location filename="../qml/pages/VideoOverview.qml" line="113"/>
    ...
    <message id="ytplayer-msg-video-unavailable-desc">
        <location filename="../qml/pages/VideoOverview.qml" line="116"/>
    ...
    <message id="ytplayer-action-download-video">
        <location filename="../qml/pages/VideoOverview.qml" line="228"/>
    ...
    <message id="ytplayer-action-cancel-download">
        <location filename="../qml/pages/VideoOverview.qml" line="236"/>
    ...
    <message id="ytplayer-action-pause-download">
        <location filename="../qml/pages/VideoOverview.qml" line="249"/>
    ...
    <message id="ytplayer-action-resume-download">
        <location filename="../qml/pages/VideoOverview.qml" line="256"/>
    ...
    <message id="ytplayer-action-remove-download">
        <location filename="../qml/pages/VideoOverview.qml" line="263"/>
    ...
    <message id="ytplayer-action-copy-link-to-clipboard">
        <location filename="../qml/pages/VideoOverview.qml" line="275"/>
    ...
    <message id="ytplayer-msg-link-copied">
        <location filename="../qml/pages/VideoOverview.qml" line="284"/>
    ...
    <message id="ytplayer-action-open-in-browser">
        <location filename="../qml/pages/VideoOverview.qml" line="291"/>
    ...
    <message id="ytplayer-label-play">
        <location filename="../qml/pages/VideoOverview.qml" line="319"/>
        <source>Play</source>
    ...
    <message id="ytplayer-label-video-downloaded">
        <location filename="../qml/pages/VideoOverview.qml" line="393"/>
    ...
    <message id="ytplayer-label-video-queued">
        <location filename="../qml/pages/VideoOverview.qml" line="398"/>
    ...
    <message id="ytplayer-label-video-download-paused">
        <location filename="../qml/pages/VideoOverview.qml" line="409"/>
    ...
    <message id="ytplayer-label-video-downloading-percentage">
        <location filename="../qml/pages/VideoOverview.qml" line="417"/>
    ...
    <message id="ytplayer-label-publish-date">
        <location filename="../qml/pages/VideoOverview.qml" line="453"/>
    ...
    <message id="ytplayer-youtube-sign-in-successful">
        <location filename="../qml/pages/YTOAuth2.qml" line="65"/>
    ...
    <message id="ytplayer-oauth-failed">
        <location filename="../qml/pages/YTOAuth2.qml" line="88"/>
        ...
        <translation>Авторизация OAuth не удалась!</translation>
    </message>
    <message id="ytplayer-oauth-page-loading-failed">
        <location filename="../qml/pages/YTOAuth2.qml" line="118"/>
    ...
    <message id="ytplayer-oauth-access-denied">
        <location filename="../qml/pages/YTOAuth2.qml" line="133"/>
    ...
    <message id="ytplayer-title-watched-recently">
        <location filename="../qml/pages/WatchedRecently.qml" line="86"/>
        <source>Watched recently</source>
    ...
    <message id="ytplayer-label-broken-image">
        <location filename="../qml/common/AsyncImage.qml" line="34"/>
    ...
    <message id="ytplayer-title-player-settings">
        <location filename="../qml/pages/PlayerSettings.qml" line="23"/>
        <source>Player settings</source>
        <extracomment>Title of video player settings page</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="ytplayer-label-autopause">
        <location filename="../qml/pages/PlayerSettings.qml" line="29"/>
    ...
    <message id="ytplayer-description-autopause">
        <location filename="../qml/pages/PlayerSettings.qml" line="32"/>
    ...
    <message id="ytplayer-label-controls-hide-delay">
        <location filename="../qml/pages/PlayerSettings.qml" line="46"/>
    ...
    <message id="ytplayer-label-autoload">
        <location filename="../qml/pages/PlayerSettings.qml" line="63"/>
    ...
    <message id="ytplayer-description-autoload">
        <location filename="../qml/pages/PlayerSettings.qml" line="66"/>
    ...
    <message id="ytplayer-action-autoload-always">
        <location filename="../qml/pages/PlayerSettings.qml" line="80"/>
    ...
    <message id="ytplayer-label-quality-wifi">
        <location filename="../qml/pages/PlayerSettings.qml" line="110"/>
    ...
    <message id="ytplayer-label-quality-cellular">
        <location filename="../qml/pages/PlayerSettings.qml" line="134"/>
